/* 
    ...
    TO PERFORM THIS, WE HAVE TO PASS ALL THE PROPERTIES OF AN OBJECT IN THE OBJECT PARAMETER ONCE.

    SYNTAX: this.property_name = paramete_name
*/
...
// ADD PROPERTY TO SPECIFIC OBJECT:
...
// DELETE PROPERTY OF SPECIFIC OBJECT:
delete stu3.lastName;
console.log(stu3); // DELETE
