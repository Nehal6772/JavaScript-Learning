...
1. NEED OF PROTOTYPE: WE CAN ADD PROPERTIES AND METHODS TO AN OBJECT EXTERNALLY. (NOT INSIDE AN OBJECT AND NOT INSIDE THE CONSTRUCTOR)

2. ADDING METHODS INTO OBJECT CONSTRUCTOR IS NOT POSSIBLE USING 3RD AND 4TH WAY BECAUSE WE ARE ADDING IT EXTERNALLY. (NOT INSIDE THE OBJECT CONSTRUCTOR)

3. TO ADD (PROPERTY OR METHOD) INTO AN OBJECT CONSTRUCTOR, WE CANNOT ADD ANYTHING DIRECTLY TO AN OBJECT EXTERNALLY.

    SYNTAX: CONSTRUCTOR_NAME.PROTOTYPE.PROPERTY_NAME = "VALUE"; // FOR PROPERTY

    SYNTAX: CONSTRUCTOR_NAME.PROTOTYPE.METHOD_NAME = FUNCTION_NAME; // FOR METHOD: 1ST WAY (NORMAL FUNCTION)
